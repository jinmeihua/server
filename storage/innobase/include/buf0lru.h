...
accessible via bpage. If this function returns true, it will also
release the LRU list mutex.
...
block mutexes will be released.
@param[in,out]	bpage	block, must contain a file page and
			be in a state where it can be freed; there
			may or may not be a hash index to the page
@oparam[in]	zip	true if should remove also the compressed
